...
describe('useOkapiKyQuery', () => {
  ...
  it('should show error calling query without api', async () => {
    const consoleErrorSpy = jest.spyOn(console, 'error').mockImplementation(() => {});

    expect(() => renderHook(() => useOkapiKyQuery({ queryKey, id }), { wrapper }))
      .toThrow('useOkapiKyQuery requires an "api" parameter');
