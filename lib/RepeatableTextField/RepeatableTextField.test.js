...
describe('RepeatableTextField', () => {
  ...
  it('should render default props: empty placeholder and first field with trash icon', async () => {
  ...
  it('custom validation is applied to non-required fields', async () => {
    renderRepeatableTextField('', ['', ''], urlValidate, false, 'Enter value');
  ...
  it('first field shows both required and custom validation error', async () => {
    renderRepeatableTextField('', [''], urlValidate, true, 'Enter value');
  ...
  it('does not show trash icon for first field when isFirstFieldRequired is true', async () => {
    renderRepeatableTextField('', ['first', 'second'], () => {}, true, 'Enter value');
  ...
  it('fieldValidate returns undefined for valid input', async () => {
    renderRepeatableTextField('', [''], urlValidate, false, 'Enter value');
